...
// ── Module state ──────────────────────────────────────
let mizoModel  = null;   // loaded tf.LayersModel
let scalerMean = null;   // number[] length 1662
let scalerStd  = null;   // number[] length 1662

// ── Rolling inference buffer ──────────────────────────
let frameBuffer    = [];   // last SEQUENCE_LEN scaled kp frames
let lastPrediction = null; // { label, confidence, scores, classIdx }
let predCooldown   = 0;    // frame counter for throttling inference
